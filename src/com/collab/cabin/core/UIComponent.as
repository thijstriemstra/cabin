...
{
	import com.collab.cabin.events.CabinEvent;
	 ...
	 *
	 * @eventType com.collab.cabin.events.CabinEvent.CREATION_COMPLETE
	 */
	[Event(name="creationComplete", type="com.collab.cabin.events.CabinEvent")]
	
	/**
	 * Dispatched when the component is closed.
	 *
	 * @eventType com.collab.cabin.events.CabinEvent.CLOSE_VIEW
	 */
	[Event(name="closeView", type="com.collab.cabin.events.CabinEvent")]
	...
	public class UIComponent extends Sprite
	{
		...
		/**
		 * Invoked when the component was added to the display list.
		 * 
		 * @param event
		 */		
		protected function onAddedToStage( event:Event ):void
		{
			...
			dispatchEvent( new CabinEvent( CabinEvent.CREATION_COMPLETE ));
		}
